...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    {
        [self.delegate colorPickerViewDismissedByOutSideClick:self.selectedColor];
    }
}
...
- (IBAction)buttonPressHue:(id)sender {
    ...
    //[self.navigationController pushViewController:controller animated:YES];// original
...
- (void)colorPickerViewController:(NEOColorPickerBaseViewController *)controller didSelectColor:(UIColor *)color {
    ...
    [self updateSelectedColor];
    //[self.navigationController popViewControllerAnimated:YES];// Original
